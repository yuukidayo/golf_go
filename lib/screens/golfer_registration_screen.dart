...
class GolferRegistrationScreen extends StatefulWidget {
  const GolferRegistrationScreen({super.key});

  @override
  State<GolferRegistrationScreen> createState() => _GolferRegistrationScreenState();
}

class _GolferRegistrationScreenState extends State<GolferRegistrationScreen> {
  ...
  Future<void> _handleRegistration() async {
    ...
    // ゴルファーのダッシュボード画面への遷移
    // TODO: ゴルファーのダッシュボード画面が実装されたら、適切な画面に遷移させる
    Future.delayed(const Duration(seconds: 1), () {
      // 現時点では仮にWelcomeScreenに戻す
